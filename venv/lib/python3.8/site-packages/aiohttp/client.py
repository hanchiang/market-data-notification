  ...
  def __del__(self, _warnings: Any = warnings) -> None:
    if not self.closed:
      if PY_36:
        ...
        kwargs = {}
      _warnings.warn(f"Unclosed client session {self!r}", ResourceWarning,
                     **kwargs)
  ...
  async def _request(
    ...
    *,
    ...
    try:
        ...
        while True:
          ...
          try:
            async with ceil_timeout(real_timeout.connect):
              ...
              conn = await self._connector.connect(req,
                                                   traces=traces,
          ...
          if resp.status in (301, 302, 303, 307, 308) and allow_redirects:
            ...
            for trace in traces:
              await trace.send_request_redirect(method,
      ...
      for trace in traces:
        await trace.send_request_end(method, url.update_query(params), headers,
                                     resp)
      return resp
      ...
      for trace in traces:
        await trace.send_request_exception(method, url.update_query(params),
                                           headers, e)
      raise
...
class _BaseRequestContextManager(Coroutine[Any, Any, _RetType],
  ...
  def __init__(self, coro: Coroutine["asyncio.Future[Any]", None,
                                     _RetType]) -> None:
    self._coro = coro
  ...
  def throw(self,
            arg: BaseException) -> None:  # type: ignore[arg-type,override]
