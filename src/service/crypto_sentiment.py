...
from src.type.sentiment import CryptoFearGreedResult, CryptoFearGreedData, CryptoFearGreedAverage
...
class CryptoSentimentService:
    ...
    async def get_crypto_fear_greed_index(self, days=365) -> CryptoFearGreedResult:
        ...
        res = CryptoFearGreedResult(data=data, average=average)

        return res

    def transform_data(self, data: AlternativeMeFearGreedIndex) -> List[CryptoFearGreedData]:
        parse_params = [
    ...
    def transform_average(self, data: AlternativeMeFearGreedIndex) -> List[CryptoFearGreedAverage]:
        average_params = [
        ...
        res: List[CryptoFearGreedAverage] = []
